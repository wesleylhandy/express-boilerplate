...
const store = new MongoDBStore({
    uri: process.env.MONGODB_CONNECT_STRING || 'mongodb://localhost:27017/connect_mongodb_session',
...
const uri = process.env.MONGODB_CONNECT_STRING || `mongodb://localhost:27017/${dbName}`;
